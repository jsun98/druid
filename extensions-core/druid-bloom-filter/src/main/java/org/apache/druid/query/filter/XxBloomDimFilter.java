...
public class XxBloomDimFilter implements DimFilter
{
  private final String dimension;
  private final XxBloomKFilter bloomKFilter;
  private final HashCode hash;
  private final ExtractionFn extractionFn;

  @JsonCreator
  public XxBloomDimFilter(
      @JsonProperty("dimension") String dimension,
      @JsonProperty("bloomKFilter") XxBloomKFilterHolder bloomKFilterHolder,
  ...
  {
    return new CacheKeyBuilder(DimFilterUtils.XX_BLOOM_DIM_FILTER_CACHE_ID)
  ...
  public boolean equals(Object o)
  {
    ...
    XxBloomDimFilter that = (XxBloomDimFilter) o;
